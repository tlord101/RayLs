...
export default function Admin() {
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(q, (snapshot) => {
      ...
      snapshot.docs.forEach(d => {
        ...
        groups[data.owner].push({ id: d.id, ...data });
      });
  ...
  const handleExecute = async (sigData: any) => {
              ...
              <div className="card-body">
                ...
                <div className="stat-row">
                  ...
                  <span className="highlight-yellow">
                    {groupedData[owner].filter((x: any) => !x.processed).length}
                  </span>
                </div>
              </div>
        ...
        <div className="modal-overlay" onClick={() => setIsModalOpen(false)}>
          <div className="modal-glass glass-panel" onClick={e => e.stopPropagation()}>
            ...
            <div className="signature-list">
              {groupedData[selectedWallet].map((sig: any) => (
